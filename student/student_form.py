...
class StudentRegistration(QWidget):
    ...
    def init_ui(self):
        ...
        """)
        self.back_button.clicked.connect(self.back_to_student_list)
    ...
    def submit_form(self):
        ...
        try:
            ...
            if idStudent and studentName and studentSurname and dob and studentGender and identificationNo and classLevel and className and parentName and parentSurname and phoneNumber and email and passwd:
                ...
                cursor.execute("SELECT idStudent FROM Students WHERE idStudent = %s", (idStudent,))
                existing_student = cursor.fetchone()

                if existing_student:
                    QMessageBox.warning(self, 'Error', 'This student ID is already in use. Please use a different ID.')
                    return
                ...
                self.save_to_database(idStudent, studentName, studentSurname, dob, studentGender, identificationNo, idClass)
    ...
    def back_to_student_list(self):
        self.main_app.show_student_list()

if __name__ == "__main__":
    app = QApplication(sys.argv)
    window = StudentRegistration(None)
    window.show()
    sys.exit(app.exec_())
